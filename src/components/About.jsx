    ...
    <div className="grid grid-cols-1 gap-6  ">
        <div className="gradient-border p-6 card-hover">
            <div className="flex items-start gap-4">
                ...
                <p className="text-muted-foreground"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit aliquid eos corrupti aliquam, dolor libero nobis laudantium blanditiis culpa ea temporibus nam ducimus porro natus alias dicta aut, vitae odio.
                </p>
            </div>
        </div>
    </div>
